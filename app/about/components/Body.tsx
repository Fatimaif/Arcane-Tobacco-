...
const Body = () => {
  return (
    <div className="flex flex-col text-blue-950 w-full  justify-start px-55 ">
      <h2 className="font-semibold text-left text-3xl mb-6">
      ...
      <h3 className="font-semibold text-left text-3xl mb-6 mt-6">
        Meeting Consumer Needs
      </h3>
      <p>
        Our strategy is centered on anticipating and satisfying the evolving preferences of our consumers. By investing in research and development, we aim to provide a portfolio of high-quality products that offer satisfying experiences while exploring innovative alternatives to traditional tobacco.
      </p>
      <h4 className="font-semibold text-left text-3xl mt-6 mb-6">
        Company Status
      </h4>
      <p className="mb-4">A subsidiary of Arcane Holdings</p>
      <h5 className="font-semibold text-left text-3xl mb-6">
        Company Registration & Tax Information
      </h5>
      <p>
        NTN Number: 0712821-5 <br/>
        Company Registration Number: Sind 242 of 1947-48 dated 18th November, 1947
      </p>
    </div>
  );
};
