  ...
  return (
    <div className="bg-white text-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl font-semibold text-blue-950 mt-8 mb-4">Your choices regarding cookies</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-blue-950 mt-8 mb-4">Changes to this Cookie Policy</h2>
        <p className="mb-4">
          We may update this Cookie Policy from time to time in order to reflect, for example, changes to the cookies we use or for other operational, legal or regulatory reasons. Please therefore re-visit this Cookie Policy regularly to stay informed about our use of cookies and related technologies.
        </p>

        <p className="mt-8 text-sm text-gray-600">
          This document is for placeholder purposes only and should be reviewed by a legal professional.
        </p>
      </div>
    </div>
  );
